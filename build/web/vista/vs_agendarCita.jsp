<%-- 
    ...
    Created on : 16/06/2025, 9:29:11 a. m.
    Author     : Anthony
--%>
...
<body>
    <div class="form-container" style=" border: 1px solid #ccc; padding: 10px; margin-top: 10px;">
        ...
        <form action="<%= request.getContextPath() %>/control/ct_agendarCita.jsp" method="post">
            ...
            <%
                ...
                ResultSet rs = c.consultar("SELECT id_odontologo, nombre_completo FROM odontologos");
                while (rs.next()) {
            %>
                <option value="<%= rs.getInt("id_odontologo") %>"><%= rs.getString("nombre_completo") %></option>
            <%
                }
                c.cerrar(); // Cierra la conexión después de usarla
            %>
            </select><br>
